...
def get_titan_image_insertion_request_body(input_image_bytes, insertion_position, insertion_dimensions):
    prompt_content = "A 20-year-old happy person wearing, who is smiling and standing beside the person"
...
def get_image_from_model(image_bytes, mask_prompt=None, negative_prompt=None, insertion_position=None, insertion_dimensions=None):
    ...
    body = get_titan_image_insertion_request_body(image_bytes, insertion_position, insertion_dimensions) #preload desk.jpg
